  ...
  return (
    <div className="bg-[#0F2A44] border border-white/10 rounded-2xl p-8 shadow-xl">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400">Preencha os dados abaixo para comecar</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-start gap-3 pt-2">
          ...
          <label htmlFor="terms" className="text-sm text-gray-400">
            Concordo com os{" "}
            <a href="#" className="text-[#16C784] hover:underline">Termos de Uso</a>{" "}
            e{" "}
            <a href="#" className="text-[#16C784] hover:underline">Politica de Privacidade</a>
          </label>
        </div>
      ...
      <p className="text-center text-gray-400">
        Ja tem uma conta?{" "}
        <Link href="/login" className="text-[#16C784] hover:text-[#2DFF88] font-medium transition-colors">
          Fazer login
        </Link>
      </p>
    </div>
